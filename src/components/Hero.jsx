...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-br from-[#E8E3F3] via-[#F0EDF7] to-[#E8E3F3]"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border border-purple-200">
            ...
            <span className="text-sm font-medium text-[#6E5B9A]">
        ...
        <div className="flex justify-center mb-6">
          <img
            ...
            // ADDED: Logo container for 3D perspective
            className="w-24 h-24 sm:w-32 sm:h-32 rounded-4xl shadow-2xl shadow-[#6E5B9A]/50 transition-all duration-300 transform rotate-y-6 hover:rotate-y-0 animate-logo-float"
          />
        </div>
        ...
        <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
          Experience the perfect harmony of ancient healing wisdom and modern
          wellness practices.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-purple-200">
            ...
            <p className="text-gray-600">
              Time-tested healing practices from Ayurveda, Chinese Medicine, and
              more
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-purple-200">
            ...
            <p className="text-gray-600">
              Drug-free treatments that work with your body's natural healing
              abilities
            </p>
          </div>
      ...
      <style>{`
        ...
        @keyframes logoFloat {
          0% {
            ...
            box-shadow: 0 10px 15px -3px rgba(110, 91, 154, 0.3), 0 4px 6px -2px rgba(110, 91, 154, 0.15);
          }
          50% {
            transform: translateY(-8px) rotate(1deg) scale(1.02);
            box-shadow: 0 20px 25px -5px rgba(110, 91, 154, 0.5), 0 10px 10px -5px rgba(110, 91, 154, 0.25);
          }
          100% {
            transform: translateY(0px) rotate(0deg) scale(1);
            box-shadow: 0 10px 15px -3px rgba(110, 91, 154, 0.3), 0 4px 6px -2px rgba(110, 91, 154, 0.15);
        ...
        /* 3D Effect utilities (if needed, but using rotate-y on img) */
        /* You might need to add 'perspective' to a parent for a more pronounced 3D effect in some cases,
           but the shadow and small rotation help a lot here. */
      `}</style>
    </section>
  );
}