...
//               </div>
//               <div>
//                 <h3 className="font-semibold text-gray-900 text-base mb-1">Phone</h3>
//                 <p className="text-gray-600 text-sm">+91 94929 70759</p>
//               </div>
//             </div>
//           </div>
...
//                 <p className="text-gray-900 font-medium text-sm">Runasi Holistic Wellness Center</p>
//                 <p className="text-gray-600 text-sm">Nagarjuna Diagnostic Center</p>
//                 <p className="text-gray-600 text-sm">Opp. St. Patrick's High School, Sebastian Road</p>
//                 <p className="text-gray-600 text-sm">Secunderabad – 500003</p>
//               </div>
//             </div>
//           </div>
